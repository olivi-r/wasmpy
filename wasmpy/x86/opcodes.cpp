    ...
    for (size_t i = 0; i < buf.size(); i++)
    {
        ...
        case 0x20: // local.get
            ...
            else if (plat == 4)
            {
                ...
                // push word 4
                // end:
                insts.push_back({0x55, 0x89, 0xE0, 0x89, 0xEC, 0x89, 0xC5, 0x81, 0xEC, (uint8_t)localidx, (uint8_t)(localidx >> 8), (uint8_t)(localidx >> 16), (uint8_t)(localidx >> 24), POP_AX, 0x66, 0x83, 0xF8, 4, JE(27), POP_AX, POP_V32A, 0x89, 0xEC, 0x5D, PUSH_V32, JMP(35), POP_EAX, POP_ECX, 0x89, 0xEC, 0x5D, PUSH_V64});
            }
            i += 4;
            break;
        ...
        case 0x21: // local.set
            ...
            else if (plat == 4)
            {
                ...
                // pop ebp
                // end:
                insts.push_back({POP_AX, 0x66, 0x83, 0xF8, 4, JE(36), POP_EAX, 0x55, 0x89, 0xE1, 0x89, 0xEC, 0x89, 0xCD, 0x81, 0xEC, (uint8_t)localidx, (uint8_t)(localidx >> 8), (uint8_t)(localidx >> 16), (uint8_t)(localidx >> 24), PUSH_V32, 0x89, 0xEC, 0x5D, JMP(48), POP_EAX, POP_ECX, 0x55, 0x89, 0xE2, 0x89, 0xEC, 0x89, 0xD5, 0x81, 0xEC, (uint8_t)localidx, (uint8_t)(localidx >> 8), (uint8_t)(localidx >> 16), (uint8_t)(localidx >> 24), PUSH_V64, 0x89, 0xEC, 0x5D});
            }
            i += 4;
            break;
        ...
        case 0x22: // local.tee
            ...
            else if (plat == 4)
            {
                ...
                // pop ebp
                // end:
                insts.push_back({POP_AX, 0x66, 0x83, 0xF8, 4, JE(49), POP_EAX, 0x89, 0xC1, PUSH_CX, SHR_ECX, PUSH_CX, V32, 0x55, 0x89, 0xE1, 0x89, 0xEC, 0x89, 0xCD, 0x81, 0xEC, (uint8_t)localidx, (uint8_t)(localidx >> 8), (uint8_t)(localidx >> 16), (uint8_t)(localidx >> 24), PUSH_V32, 0x89, 0xEC, 0x5D, JMP(71), POP_EAX, POP_ECX, 0x89, 0xC2, 0x89, 0xCB, PUSH_BX, SHR_EBX, PUSH_BX, PUSH_DX, SHR_EDX, PUSH_DX, V64, 0x55, 0x89, 0xE2, 0x89, 0xEC, 0x89, 0xD5, 0x81, 0xEC, (uint8_t)localidx, (uint8_t)(localidx >> 8), (uint8_t)(localidx >> 16), (uint8_t)(localidx >> 24), PUSH_V64, 0x89, 0xEC, 0x5D});
            }
            i += 4;
            break;
        ...
        case 0x53: // i64.lt_s
            ...
            // push word 0
            // push word 2
            insts.push_back({POP_V64A, POP_V64B, 0x39, 0xC2, 0x7C, 12, 0x7F, 4, 0x39, 0xCB, 0x72, 6, PUSH(0), JMP(4), PUSH(1), PUSH(0), V32});
            break;
        ...
        case 0x54: // i64.lt_u
            ...
            // push word 0
            // push word 2
            insts.push_back({POP_V64A, POP_V64B, 0x39, 0xC2, 0x72, 12, 0x77, 4, 0x39, 0xCB, 0x72, 6, PUSH(0), JMP(4), PUSH(1), PUSH(0), V32});
            break;
        ...
        case 0x56: // i64.gt_u
            ...
            // push word 0
            // push word 2
            insts.push_back({POP_V64A, POP_V64B, 0x39, 0xC2, 0x77, 12, 0x72, 4, 0x39, 0xCB, 0x77, 6, PUSH(0), JMP(4), PUSH(1), PUSH(0), V32});
            break;
        ...
        case 0x57: // i64.le_s
            ...
            // push word 0
            // push word 2
            insts.push_back({POP_V64A, POP_V64B, 0x39, 0xC2, 0x7C, 12, 0x7F, 4, 0x39, 0xCB, 0x76, 6, PUSH(0), JMP(4), PUSH(1), PUSH(0), V32});
            break;
        ...
        case 0x58: // i64.le_u
            ...
            // push word 0
            // push word 2
            insts.push_back({POP_V64A, POP_V64B, 0x39, 0xC2, 0x72, 12, 0x77, 4, 0x39, 0xCB, 0x76, 6, PUSH(0), JMP(4), PUSH(1), PUSH(0), V32});
            break;
        ...
        case 0x59: // i64.ge_s
            ...
            // push word 0
            // push word 2
            insts.push_back({POP_V64A, POP_V64B, 0x39, 0xC2, 0x7F, 12, 0x7C, 4, 0x39, 0xCB, 0x73, 6, PUSH(0), JMP(4), PUSH(1), PUSH(0), V32});
            break;
        ...
        case 0x5A: // i64.ge_u
            ...
            // push word 0
            // push word 2
            insts.push_back({POP_V64A, POP_V64B, 0x39, 0xC2, 0x77, 12, 0x72, 4, 0x39, 0xCB, 0x73, 6, PUSH(0), JMP(4), PUSH(1), PUSH(0), V32});
            break;
